...
class MH_Button_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                // Adds class .mh-button-size-[value] to the button
            ]
        );
    ...
    protected function render_button_content($settings) {
        ...
        // Render Icon (Left)
        if (!empty($settings['icon']['value']) && $icon_align == 'left') : ?>
        ...
        <?php 
        // Render Icon (Right)
        if (!empty($settings['icon']['value']) && $icon_align == 'right') : ?>
            <span <?php echo $this->get_render_attribute_string('icon-align'); ?>>
                <?php Icons_Manager::render_icon($settings['icon'], ['aria-hidden' => 'true']); ?>
            </span>
        <?php endif; ?>

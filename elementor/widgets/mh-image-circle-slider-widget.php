...
class MH_Image_Circle_Slider_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'dots_color_normal', [ 'label' => esc_html__('Color', 'mh-plug'), 'type' => Controls_Manager::COLOR, 'default' => '#cccccc', 'selectors' => [ '{{WRAPPER}} .mh-brush-slider-wrapper .slick-dots li button' => 'border-color: {{VALUE}}; background-color: transparent;' ], 'condition' => [ 'show_dots' => 'yes' ] ] );

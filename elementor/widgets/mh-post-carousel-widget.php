...
class MH_Post_Carousel_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'btn_color', [ 'label' => 'Color', 'type' => Controls_Manager::COLOR, 'selectors' => [ '{{WRAPPER}} .mh-post-button' => 'color: {{VALUE}};' ] ] );
        $this->add_control( 'btn_bg_color', [ 'label' => 'Background', 'type' => Controls_Manager::COLOR, 'selectors' => [ '{{WRAPPER}} .mh-post-button' => 'background-color: {{VALUE}};' ] ] );
        $this->end_controls_tab();
        $this->start_controls_tab( 'tab_btn_hover', ['label' => 'Hover'] );
        $this->add_control( 'btn_color_hover', [ 'label' => 'Color', 'type' => Controls_Manager::COLOR, 'selectors' => [ '{{WRAPPER}} .mh-post-button:hover' => 'color: {{VALUE}};' ] ] );
